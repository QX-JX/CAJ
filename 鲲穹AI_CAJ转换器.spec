...
datas = [('C:\\Users\\admin\\Desktop\\总任务\\任务四-鲲穹AI CAJ转换器\\caj_converter\\CAJ转换器.ico', '.'), ('鲲穹01.ico', '.'), ('lib/caj2pdf', 'lib/caj2pdf')]
binaries = []
...
exe = EXE(
    ...
    icon=['C:\\Users\\admin\\Desktop\\总任务\\任务四-鲲穹AI CAJ转换器\\caj_converter\\CAJ转换器.ico'],
)
coll = COLLECT(
    exe,
    a.binaries,
